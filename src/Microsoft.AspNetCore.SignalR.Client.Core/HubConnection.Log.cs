...
namespace Microsoft.AspNetCore.SignalR.Client
{
    public partial class HubConnection
    {
        private static class Log
        {
            ...
            private static readonly Action<ILogger, string, Exception> _sendingInvocation =
                LoggerMessage.Define<string>(LogLevel.Debug, new EventId(5, "SendingInvocation"), "Sending Invocation '{InvocationId}'.");

            private static readonly Action<ILogger, string, Exception> _invocationSent =
                LoggerMessage.Define<string>(LogLevel.Debug, new EventId(6, "InvocationSent"), "Sending Invocation '{InvocationId}' completed.");
            ...
            private static readonly Action<ILogger, string, Exception> _sendingCancelation =
            ...
            public static void SendingInvocation(ILogger logger, string invocationId)
            {
                _sendingInvocation(logger, invocationId, null);
            }

            public static void InvocationSent(ILogger logger, string invocationId)
            {
                _invocationSent(logger, invocationId, null);
            }
            ...
            public static void SendingCancelation(ILogger logger, string invocationId)
            {
                _sendingCancelation(logger, invocationId, null);
            }
